...
export const AnimatedTooltip = ({
  ...
  const handleMouseMove = (event: MouseEvent) => {
    if (event.target instanceof HTMLElement) {
      ...
      // Make sure to handle the case where x is a ref or a state setter
      // This is a placeholder, you need to replace it with the appropriate code
      // For example, if x is a state, you should use `setX`
      // If it's a ref, you should use `x.current`
